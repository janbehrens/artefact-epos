...
$string['nolanguageselected'] = "You do not have any self-evaluations. Go to %s to add one.";
...
$string['competencearea'] = 'Competence area';
$string['competencelevel'] = 'Competence level';
...
$string['addcustomcompetenceformtitle'] = 'Add competence';
$string['customlearninggoal'] = 'Additional competence';
...
$string['overallrating'] = "Overall rating for";
...
$string['incomingrequests'] = "Received requests";
$string['outgoingrequests'] = "Sent requests";
$string['notyetevaluated'] = "not yet evaluated";
$string['reply'] = "Reply";
$string['evaluate'] = "Evaluate";
$string['display'] = "Display evaluation";
$string['sentto'] = "Sent to";
$string['receivedfrom'] = "Received from";
$string['replied'] = "Replied";
$string['includeevaluation'] = "Include my evaluation";
...
$string['noMemberInInstitution'] = "There are no other members in your institutions.";
$string['noUserFoundBasedOnEntered'] = "No user found.";
$string['noInstitutionErrorMsg'] = "You can only search the users of your institution, and you are not in any institution.";
