...
EOL
                ...
                if ($isOverall) {
                    ...
                    if (is_mysql()) {
                        $sql = "DELETE FROM ei
                                ...
                                WHERE ei.evaluation_id = ? AND ei.type = ? AND d.competence_id = ? AND d.level_id = ?";
                    }
                    ...
                    foreach ($compleveldata['descriptors'] as $descriptor => $descriptordata) {
                        if ($type === EVALUATION_ITEM_TYPE_DESCRIPTOR) {
                            $where->descriptor_id = $descriptor;
                            $data->descriptor_id = $descriptor;
                        }
    ...
    public static function get_all_stored_evaluation_records() {
        ...
        $evaluations = get_records_sql_array("
                ...
                LEFT JOIN artefact_epos_descriptorset d ON e.descriptorset_id = d.id
